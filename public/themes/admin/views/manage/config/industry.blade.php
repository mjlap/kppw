...
<script type="text/javascript">
    ...
    $("#add").click( function () {
        ...
        $("#sample-table tr:eq(-1)").before("<tr><td class='center'>&nbsp;</td>"+"<td>&nbsp;</td>"+"<td><input name='add["+addCount+"][name]' type='text'></td>" +"<td><input type='text' name='add["+addCount+"][sort]'></td>" +"<td class='hidden-480'> </td></tr>"
        );
    });
